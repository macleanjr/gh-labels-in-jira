                    ...
                    if (prstatus != "DECLINED" || (HIDE_LABELS_ON_CLOSED_PRS == false && HIDE_CLOSED_PRS == false)) {
                        ...
                        $.getJSON(buildURL, function (data) {
                            ...
                            $.each(data.labels, function () {
                                ...
                                $(pullRequestNode).append("<div data-label-id=\"" + label_id + "\" style=\"margin-top:3px; height: 20px; padding: 0.15em 4px; font-size:12px; font-weight:600 line-height:15px; border-radius: 2px; background-color: #" + this.color + ";color: " + idealTextColor("#" + this.color) + ";\">" + this.name + "</div>");
